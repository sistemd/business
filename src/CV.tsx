...
export default function CV() {
    function onSendEmailClick() {
        (document.querySelector('#email') as any).click()
    }
    ...
    return (
        <p className='cv'>
            ...
            CSS, SCSS. I have worked on various projects in the following languages: Go, C++, C, Python, C#, JS/TypeScript.
            ...
            ASP.NET, Rust. I am a microservice architecture enthusiast. It really is a great idea.
            <br/><br/>
            If you wish to work with me, please <button onClick={onSendEmailClick} className='send-me-email'>send me
            an email</button>.
        </p>
    )
}
